...
export function Hero() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #0B3175 0%, #0d3d93 60%, #1a4fa8 100%)" }}
    >
      ...
      />
      <div
        className="absolute top-1/3 right-8 w-3 h-3 rounded-full bg-[#FBBF24] opacity-60"
      />
      <div
        className="absolute top-1/4 left-8 w-2 h-2 rounded-full bg-[#FBBF24] opacity-40"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-[#FBBF24]/30 mb-6">
            ...
            <span className="text-[#FBBF24] text-xs" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600 }}>
          ...
          <h1
            ...
            style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, fontSize: "clamp(2rem, 6vw, 3.5rem)", lineHeight: 1.15 }}
          >
          ...
          <p
            ...
            style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 400, fontSize: "1rem", lineHeight: 1.7 }}
          >
            Bimbingan belajar terpercaya di Batu Bara, Sumatera Utara — melayani program Calistung, Matematika, Bahasa Inggris, hingga Les Ngaji dalam suasana yang nyaman dan menyenangkan.
          </p>
          ...
          <div className="flex items-start gap-2 mb-8 text-white/60">
            ...
            <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.875rem" }}>
              Gang Muhsin, Depan SPBU Simpang Bandar Tinggi, Kec. Sei Suka, Kab. Batu Bara
            </p>
          </div>
